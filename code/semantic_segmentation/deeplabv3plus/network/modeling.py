...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone, arma):
    ...
    backbone = resnet.__dict__[backbone_name](
        ...
        replace_stride_with_dilation=replace_stride_with_dilation, arma=arma)
    ...
    if name=='deeplabv3plus':
        ...
        classifier = DeepLabHeadV3Plus(inplanes, low_level_planes, num_classes, aspp_dilate, arma)
    elif name=='deeplabv3':
...
def _load_model(arch_type, backbone, num_classes, output_stride, pretrained_backbone, arma):

    if backbone=='mobilenetv2':
        model = _segm_mobilenet(arch_type, backbone, num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    elif backbone.startswith('resnet'):
        model = _segm_resnet(arch_type, backbone, num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone, arma=arma)
...
def deeplabv3plus_resnet50(num_classes=21, output_stride=8, pretrained_backbone=True, arma=False):
    """Constructs a DeepLabV3 model with a ResNet-50 backbone.
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3plus', 'resnet50', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone, arma=arma)
